...
class AccessoriesSpider(scrapy.Spider):
    ...
    max_pages = 100  # Max number of pages to scrape
    ...
    def construct_url(self, page):
        ...
        return (
            ...
            "%22number_range_filters%22:[]}&q=&for_category=642&category_path=photo/accessories"
    ...
    async def parse(self, response):
        ...
        for product in products:
            yield {
                'title': product.css('div.item-details h2 a::text').get().strip()
